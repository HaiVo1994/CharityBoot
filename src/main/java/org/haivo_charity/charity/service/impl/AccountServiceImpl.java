...
import org.haivo_charity.charity.repository.AccountRepository;
import org.haivo_charity.charity.repository.DonateRepository;
import org.haivo_charity.charity.repository.VolunteerRepository;
import org.haivo_charity.charity.repository.VoteRepository;
...
public class AccountServiceImpl implements AccountService {
    ...
    public Account update(Account originAccount, String userName, String oldPassWord,
        ...
        if (oldPassWord.equals(originAccount.getPassword())){
            ...
            originAccount.setPassword(encoder.encode(newPassword));
