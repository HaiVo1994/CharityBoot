package org.haivo_charity.charity.controller.login;
...
import org.haivo_charity.charity.model.support.RegExp;
import org.haivo_charity.charity.model.support.VoteFileUpload;
import org.haivo_charity.charity.service.CategoryService;
...
//        }
        ...
        System.out.println(uploadRootDir.getPath());
        System.out.println("________________________________");
        MultipartFile[] fileDatas = voteFileUpload.getFileDatas();
        Vote vote = new Vote();
